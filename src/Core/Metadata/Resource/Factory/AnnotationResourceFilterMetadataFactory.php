...
use Drupal\api_platform\Core\Util\AnnotationFilterExtractorTrait;
use Doctrine\Common\Annotations\Reader;

class AnnotationResourceFilterMetadataFactory implements ResourceMetadataFactoryInterface {
